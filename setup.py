...
setup(
    ...
    entry_points={
        "openff.toolkit.plugins.handlers": [
            ...
            "LeeKrimmHandler = smirnoff_plugins.handlers.bonded:LeeKrimmHandler",
            "TwoMinimaHandler = smirnoff_plugins.handlers.bonded:TwoMinimaHandler",
        ...
        "openff.interchange.plugins.collections": [
            ...
            "LeeKrimmCollection = smirnoff_plugins.collections.bonded:LeeKrimmCollection",            
            "TwoMinimaCollection = smirnoff_plugins.collections.bonded:TwoMinimaCollection",
